...
let allVisits = [
  {
    ...
    purpose: "Surgery",
    date: "2026-09-23",
    summary: "Remove liver",
  },
  {
    patientId: "PAT-001",
    purpose: "Follow-up",
    date: "2026-08-12",
    summary: "Hypertension check",
  },
  {
    patientId: "PAT-001",
    purpose: "Consultation",
    date: "2026-05-07",
    summary: "Review condition",
  },
];
...
async function loadData() {
  try {
    ...
    if (newEl) newEl.innerText = patients.length;
    ...
    showToast("Failed to load patients from database.");
  }
}
