  ...
  return `
    <tr class="hover:bg-slate-50">
        ...
        <td class="action">
            ...
            <div class="has-tooltip">
                <i class="delete fa-solid fa-trash" style="color: #ef4444;" onclick="removePatient('${patient.id}')"></i>
...
async function loadData() {
  ...
  try {
    ...
    updatePatientSummaryCards(patients.length, newThisMonthCount, activeCount, inactiveCount);
    refreshPatientList();
  } catch (error) {
    ...
    showToast("Failed to load patients from database. Check your Supabase key in .env.");
  }
}
